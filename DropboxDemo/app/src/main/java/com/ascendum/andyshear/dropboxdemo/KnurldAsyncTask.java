...
public class KnurldAsyncTask {
    ...
    public KnurldAsyncTask(AsyncKnurldResponse response, String... strings) {
        KnurldAsync knurldAsync = new KnurldAsync();
        knurldAsync.delegate = response;
        knurldAsync.execute(strings);
    }
...
//                writer.append("Content-Transfer-Encoding: binary").append(LINE_FEED);
    ...
    private class KnurldAsync extends AsyncTask<String, String, String[]> {
